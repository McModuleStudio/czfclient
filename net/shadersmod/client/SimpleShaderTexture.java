...
public class SimpleShaderTexture extends AbstractTexture {
	...
	public void loadTexture(IResourceManager resourceManager) throws IOException {
		...
		if (inputstream == null) {
			...
			try {
				...
				TextureUtil.uploadTextureImageAllocate(this.getGlTextureId(), bufferedimage,
						texturemetadatasection.getTextureBlur(), texturemetadatasection.getTextureClamp());
			} finally {
	...
	private TextureMetadataSection loadTextureMetadataSection() {
		...
		if (inputstream != null) {
			...
			try {
				...
				TextureMetadataSection texturemetadatasection = (TextureMetadataSection) imetadataserializer
	...
	private static IMetadataSerializer makeMetadataSerializer() {
		...
		imetadataserializer.registerMetadataSectionType(new TextureMetadataSectionSerializer(),
		...
		imetadataserializer.registerMetadataSectionType(new AnimationMetadataSectionSerializer(),
		...
		imetadataserializer.registerMetadataSectionType(new LanguageMetadataSectionSerializer(),
