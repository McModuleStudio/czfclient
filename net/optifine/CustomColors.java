...
public class CustomColors {
	...
	private static final CustomColors.IColorizer COLORIZER_GRASS = new CustomColors.IColorizer() {
		public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_) {
			...
			return CustomColors.swampGrassColors != null && biomegenbase == BiomeGenBase.swampland
					? CustomColors.swampGrassColors.getColor(biomegenbase, p_getColor_2_)
	...
	private static final CustomColors.IColorizer COLORIZER_FOLIAGE = new CustomColors.IColorizer() {
		public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_) {
			...
			return CustomColors.swampFoliageColors != null && biomegenbase == BiomeGenBase.swampland
					? CustomColors.swampFoliageColors.getColor(biomegenbase, p_getColor_2_)
	...
	private static final CustomColors.IColorizer COLORIZER_FOLIAGE_PINE = new CustomColors.IColorizer() {
		public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_) {
			return CustomColors.foliagePineColors != null
					? CustomColors.foliagePineColors.getColor(p_getColor_1_, p_getColor_2_)
	...
	private static final CustomColors.IColorizer COLORIZER_FOLIAGE_BIRCH = new CustomColors.IColorizer() {
		public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_) {
			return CustomColors.foliageBirchColors != null
					? CustomColors.foliageBirchColors.getColor(p_getColor_1_, p_getColor_2_)
	...
	private static final CustomColors.IColorizer COLORIZER_WATER = new CustomColors.IColorizer() {
		public int getColor(IBlockAccess p_getColor_1_, BlockPos p_getColor_2_) {
			BiomeGenBase biomegenbase = CustomColors.getColorBiome(p_getColor_1_, p_getColor_2_);
			return CustomColors.waterColors != null ? CustomColors.waterColors.getColor(biomegenbase, p_getColor_2_)
	...
	private static CustomColormap[] readCustomColormaps(Properties p_readCustomColormaps_0_,
		...
		if (list.size() <= 0) {
			...
			CustomColormap[] acustomcolormap = (CustomColormap[]) ((CustomColormap[]) list
	...
	private static CustomColormap[][] blockListToArray(List p_blockListToArray_0_) {
		...
		for (int i = 0; i < p_blockListToArray_0_.size(); ++i) {
			...
			if (list != null) {
				CustomColormap[] acustomcolormap1 = (CustomColormap[]) ((CustomColormap[]) list
						.toArray(new CustomColormap[list.size()]));
	...
	public static int getColorMultiplier(BakedQuad p_getColorMultiplier_0_, Block p_getColorMultiplier_1_,
		...
		if (blockColormaps != null) {
			...
			if (customcolormap != null) {
				if (Config.isSmoothBiomes() && !customcolormap.isColorConstant()) {
					return getSmoothColorMultiplier(p_getColorMultiplier_2_, p_getColorMultiplier_3_, customcolormap,
		...
		if (!p_getColorMultiplier_0_.hasTintIndex()) {
			...
			return getStemColorMultiplier(p_getColorMultiplier_1_, p_getColorMultiplier_2_, p_getColorMultiplier_3_,
			...
			if (p_getColorMultiplier_1_ != Blocks.grass && p_getColorMultiplier_1_ != Blocks.tallgrass
					&& p_getColorMultiplier_1_ != Blocks.double_plant) {
			...
			return Config.isSmoothBiomes() && !customcolors$icolorizer.isColorConstant()
					? getSmoothColorMultiplier(p_getColorMultiplier_2_, p_getColorMultiplier_3_,
							customcolors$icolorizer, p_getColorMultiplier_4_.getColorizerBlockPosM())
	...
	private static int getSmoothColorMultiplier(IBlockAccess p_getSmoothColorMultiplier_0_,
			BlockPos p_getSmoothColorMultiplier_1_, CustomColors.IColorizer p_getSmoothColorMultiplier_2_,
	...
	public static int getFluidColor(IBlockAccess p_getFluidColor_0_, IBlockState p_getFluidColor_1_,
		...
		return customcolors$icolorizer == null ? block.colorMultiplier(p_getFluidColor_0_, p_getFluidColor_2_)
				: (Config.isSmoothBiomes() && !customcolors$icolorizer.isColorConstant()
						? getSmoothColorMultiplier(p_getFluidColor_0_, p_getFluidColor_2_, customcolors$icolorizer,
								p_getFluidColor_3_.getColorizerBlockPosM())
						: customcolors$icolorizer.getColor(p_getFluidColor_0_, p_getFluidColor_2_));
	}
	...
	public static void updateReddustFX(EntityFX p_updateReddustFX_0_, IBlockAccess p_updateReddustFX_1_,
	...
	public static void updateWaterFX(EntityFX p_updateWaterFX_0_, IBlockAccess p_updateWaterFX_1_,
	...
	private static int getLilypadColorMultiplier(IBlockAccess p_getLilypadColorMultiplier_0_,
		...
		return lilyPadColor < 0
				? Blocks.waterlily.colorMultiplier(p_getLilypadColorMultiplier_0_, p_getLilypadColorMultiplier_1_)
				: lilyPadColor;
	}
	...
	public static Vec3 getSkyColor(Vec3 p_getSkyColor_0_, IBlockAccess p_getSkyColor_1_, double p_getSkyColor_2_,
	...
	private static Vec3 getFogColor(Vec3 p_getFogColor_0_, IBlockAccess p_getFogColor_1_, double p_getFogColor_2_,
	...
	public static Vec3 getUnderwaterColor(IBlockAccess p_getUnderwaterColor_0_, double p_getUnderwaterColor_1_,
	...
	public static Vec3 getWorldFogColor(Vec3 p_getWorldFogColor_0_, WorldClient p_getWorldFogColor_1_,
		...
		case 0:
			...
			p_getWorldFogColor_0_ = getFogColor(p_getWorldFogColor_0_, minecraft.theWorld, p_getWorldFogColor_2_.posX,
	...
	public static Vec3 getWorldSkyColor(Vec3 p_getWorldSkyColor_0_, World p_getWorldSkyColor_1_,
		...
		case 0:
			Minecraft minecraft = Minecraft.getMinecraft();
			p_getWorldSkyColor_0_ = getSkyColor(p_getWorldSkyColor_0_, minecraft.theWorld, p_getWorldSkyColor_2_.posX,
	...
	public static int getColorFromItemStack(ItemStack p_getColorFromItemStack_0_, int p_getColorFromItemStack_1_,
		...
		if (p_getColorFromItemStack_0_ == null) {
			...
			return item == null ? p_getColorFromItemStack_2_
					: (item instanceof ItemMonsterPlacer
							? getSpawnEggColor((ItemMonsterPlacer) item, p_getColorFromItemStack_0_,
									p_getColorFromItemStack_1_, p_getColorFromItemStack_2_)
	...
	private static int getMapColorIndex(String p_getMapColorIndex_0_) {
		return p_getMapColorIndex_0_ == null ? -1
				: (p_getMapColorIndex_0_.equals("air") ? MapColor.airColor.colorIndex
						: (p_getMapColorIndex_0_.equals("grass") ? MapColor.grassColor.colorIndex
								: (p_getMapColorIndex_0_.equals("sand") ? MapColor.sandColor.colorIndex
										: (p_getMapColorIndex_0_.equals("cloth") ? MapColor.clothColor.colorIndex
												: (p_getMapColorIndex_0_.equals("tnt") ? MapColor.tntColor.colorIndex
														: (p_getMapColorIndex_0_.equals("ice")
																? MapColor.iceColor.colorIndex
																: (p_getMapColorIndex_0_.equals("iron")
																		? MapColor.ironColor.colorIndex
																		: (p_getMapColorIndex_0_.equals("foliage")
																				? MapColor.foliageColor.colorIndex
																				: (p_getMapColorIndex_0_.equals("clay")
																						? MapColor.clayColor.colorIndex
																						: (p_getMapColorIndex_0_.equals(
																								"dirt") ? MapColor.dirtColor.colorIndex
																										: (p_getMapColorIndex_0_
																												.equals("stone")
																																																																																						...
																																																																																						.equals("lightBlue")
																																																																																								? (p_getMapColorIndex_0_
																																																																																										.equals("yellow")
																																																																																												...
																																																																																												: (p_getMapColorIndex_0_
																																																																																														.equals("lime")
																																																																																																? MapColor.limeColor.colorIndex
																																																																																																: (p_getMapColorIndex_0_
																																																																																																		.equals("pink")
																																																																																																				? MapColor.pinkColor.colorIndex
																																																																																																				: (p_getMapColorIndex_0_
																																																																																																						.equals("gray")
																																																																																																								? MapColor.grayColor.colorIndex
																																																																																																								: (p_getMapColorIndex_0_
																																																																																																										.equals("silver")
																																																																																																												? MapColor.silverColor.colorIndex
																																																																																																												: (p_getMapColorIndex_0_
																																																																																																														.equals("cyan")
																																																																																																																? MapColor.cyanColor.colorIndex
																																																																																																																: (p_getMapColorIndex_0_
																																																																																																																		.equals("purple")
																																																																																																																				? MapColor.purpleColor.colorIndex
																																																																																																																				: (p_getMapColorIndex_0_
																																																																																																																						.equals("blue")
																																																																																																																								? MapColor.blueColor.colorIndex
																																																																																																																								: (p_getMapColorIndex_0_
																																																																																																																										.equals("brown")
																																																																																																																												? MapColor.brownColor.colorIndex
																																																																																																																												: (p_getMapColorIndex_0_
																																																																																																																														.equals("green")
