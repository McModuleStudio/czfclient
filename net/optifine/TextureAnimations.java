...
public class TextureAnimations {
	...
	public static TextureAnimation[] getTextureAnimations(IResourcePack[] p_getTextureAnimations_0_) {
		...
		TextureAnimation[] atextureanimation1 = (TextureAnimation[]) ((TextureAnimation[]) list
				.toArray(new TextureAnimation[list.size()]));
		return atextureanimation1;
	}

	public static TextureAnimation[] getTextureAnimations(IResourcePack p_getTextureAnimations_0_) {
		String[] astring = ResUtils.collectFiles(p_getTextureAnimations_0_, (String) "mcpatcher/anim",
		...
		if (astring.length <= 0) {
			...
			TextureAnimation[] atextureanimation = (TextureAnimation[]) ((TextureAnimation[]) list
					.toArray(new TextureAnimation[list.size()]));
			return atextureanimation;
		}
	}

	public static TextureAnimation makeTextureAnimation(Properties p_makeTextureAnimation_0_,
			ResourceLocation p_makeTextureAnimation_1_) {
			...
			if (i >= 0 && j >= 0 && k >= 0 && l >= 0) {
				...
				if (abyte == null) {
					...
					if (!Config.hasResource(resourcelocation)) {
						...
						TextureAnimation textureanimation = new TextureAnimation(s, abyte, s1, resourcelocation, i, j,
								k, l, p_makeTextureAnimation_0_, 1);
	...
	public static BufferedImage scaleBufferedImage(BufferedImage p_scaleBufferedImage_0_, int p_scaleBufferedImage_1_,
			int p_scaleBufferedImage_2_) {
		...
		graphics2d.drawImage(p_scaleBufferedImage_0_, 0, 0, p_scaleBufferedImage_1_, p_scaleBufferedImage_2_,
				(ImageObserver) null);
		return bufferedimage;
	}
}
