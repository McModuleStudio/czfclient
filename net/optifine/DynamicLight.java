...
public class DynamicLight {
	...
	public void update(RenderGlobal p_update_1_) {
		...
		if (Math.abs(d2) > d5 || Math.abs(d3) > d5 || Math.abs(d4) > d5 || this.lastLightLevel != j) {
			...
			if (world != null) {
				this.blockPosMutable.func_181079_c(MathHelper.floor_double(d6), MathHelper.floor_double(d0),
	...
	private void updateChunkLight(RenderChunk p_updateChunkLight_1_, Set<BlockPos> p_updateChunkLight_2_,
			Set<BlockPos> p_updateChunkLight_3_) {
