...
public class JsonToNBT {
	...
	static JsonToNBT.Any func_150316_a(String p_150316_0_, String p_150316_1_) throws NBTException {
		...
		if (p_150316_1_.startsWith("{")) {
			...
			for (jsontonbt$compound = new JsonToNBT.Compound(p_150316_0_); p_150316_1_
					.length() > 0; p_150316_1_ = p_150316_1_.substring(s1.length() + 1)) {
			...
			for (jsontonbt$list = new JsonToNBT.List(p_150316_0_); p_150316_1_.length() > 0; p_150316_1_ = p_150316_1_
