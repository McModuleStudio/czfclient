			...
			if (combatentry != null && combatentry1.getDamageSrc() == DamageSource.fall) {
				...
				if (combatentry.getDamageSrc() != DamageSource.fall
					...
					if (ichatcomponent2 != null
							&& (ichatcomponent1 == null || !ichatcomponent2.equals(ichatcomponent1))) {
						...
						if (itemstack1 != null && itemstack1.hasDisplayName()) {
							ichatcomponent = new ChatComponentTranslation("death.fell.assist.item", new Object[] {
							...
							ichatcomponent = new ChatComponentTranslation("death.fell.assist",
									new Object[] { this.fighter.getDisplayName(), ichatcomponent2 });
						}
						...
						if (itemstack != null && itemstack.hasDisplayName()) {
							ichatcomponent = new ChatComponentTranslation("death.fell.finish.item", new Object[] {
	...
	private CombatEntry func_94544_f() {
		...
		for (int j = 0; j < this.combatEntries.size(); ++j) {
			...
			if (combatentry2.func_94562_g() != null
					&& (combatentry1 == null || combatentry2.func_94563_c() > (float) i)) {
