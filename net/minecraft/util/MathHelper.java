...
public class MathHelper {
	...
	public static int func_181758_c(float p_181758_0_, float p_181758_1_, float p_181758_2_) {
		...
		default:
			throw new RuntimeException("Something went wrong when converting from HSV to RGB. Input was " + p_181758_0_
					+ ", " + p_181758_1_ + ", " + p_181758_2_);
		}
	...
	static {
		...
		for (int l = 0; l < 360; l += 90) {
			SIN_TABLE_FAST[(int) ((float) l * 11.377778F) & 4095] = (float) Math
					.sin((double) ((float) l * 0.017453292F));
		}
	   ...
	   public static int getRandomIntegerInRange(Random p_76136_0_, float maxRotations, float maxRotations2) {
	      return (int)(maxRotations >= maxRotations2?maxRotations:(float)p_76136_0_.nextInt() + maxRotations);
	   }
