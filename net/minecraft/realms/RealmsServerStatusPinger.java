...
public class RealmsServerStatusPinger {
	...
	private final List<NetworkManager> connections = Collections
	...
	public void pingServer(final String p_pingServer_1_, final RealmsServerPing p_pingServer_2_)
		...
		if (p_pingServer_1_ != null && !p_pingServer_1_.startsWith("0.0.0.0") && !p_pingServer_1_.isEmpty()) {
			...
			networkmanager.setNetHandler(new INetHandlerStatusClient() {
				...
				public void handleServerInfo(S00PacketServerInfo packetIn) {
					...
					if (serverstatusresponse.getPlayerCountData() != null) {
						p_pingServer_2_.nrOfPlayers = String
								.valueOf(serverstatusresponse.getPlayerCountData().getOnlinePlayerCount());
			...
			try {
				networkmanager.sendPacket(new C00Handshake(RealmsSharedConstants.NETWORK_PROTOCOL_VERSION,
						realmsserveraddress.getHost(), realmsserveraddress.getPort(), EnumConnectionState.STATUS));
