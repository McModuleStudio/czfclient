...
public class DisconnectedRealmsScreen extends RealmsScreen {
	...
	public void init() {
		...
		this.buttonsAdd(newButton(0, this.width() / 2 - 100,
				this.height() / 2 + this.textHeight / 2 + this.fontLineHeight(), getLocalizedString("gui.back")));
	}
	...
	public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
		...
		this.drawCenteredString(this.title, this.width() / 2,
				this.height() / 2 - this.textHeight / 2 - this.fontLineHeight() * 2, 11184810);
