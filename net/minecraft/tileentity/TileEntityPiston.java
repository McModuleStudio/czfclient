...
public class TileEntityPiston extends TileEntity implements ITickable {
			...
			if (!list.isEmpty()) {
				...
				for (Entity entity : this.field_174933_k) {
					if (this.pistonState.getBlock() == Blocks.slime_block && this.extending) {
						...
						entity.moveEntity((double) (p_145863_2_ * (float) this.pistonFacing.getFrontOffsetX()),
								(double) (p_145863_2_ * (float) this.pistonFacing.getFrontOffsetY()),
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		this.pistonState = Block.getBlockById(compound.getInteger("blockId"))
