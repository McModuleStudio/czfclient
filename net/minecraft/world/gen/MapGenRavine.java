...
public class MapGenRavine extends MapGenBase {
	...
	protected void func_180707_a(long p_180707_1_, int p_180707_3_, int p_180707_4_, ChunkPrimer p_180707_5_,
		...
		for (; p_180707_15_ < p_180707_16_; ++p_180707_15_) {
			double d9 = 1.5D + (double) (MathHelper.sin((float) p_180707_15_ * (float) Math.PI / (float) p_180707_16_)
					* p_180707_12_ * 1.0F);
									...
									for (int j2 = l; j2 > l2; --j2) {
										...
										if ((d10 * d10 + d7 * d7) * (double) this.field_75046_d[j2 - 1]
											...
											if (iblockstate1.getBlock() == Blocks.stone
												...
												if (j2 - 1 < 10) {
													p_180707_5_.setBlockState(j3, j2, i2,
															Blocks.flowing_lava.getDefaultState());
												} else {
													p_180707_5_.setBlockState(j3, j2, i2, Blocks.air.getDefaultState());

													if (flag && p_180707_5_.getBlockState(j3, j2 - 1, i2)
															.getBlock() == Blocks.dirt) {
														blockpos$mutableblockpos.func_181079_c(j3 + p_180707_3_ * 16, 0,
																i2 + p_180707_4_ * 16);
														p_180707_5_.setBlockState(j3, j2 - 1, i2,
	...
	protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_,
		...
		if (this.rand.nextInt(50) == 0) {
			...
			for (int j = 0; j < i; ++j) {
				...
				this.func_180707_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2, f, f1,
						0, 0, 3.0D);
			}
		}
	}
