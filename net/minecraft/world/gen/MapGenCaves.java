...
public class MapGenCaves extends MapGenBase {
	protected void func_180703_a(long p_180703_1_, int p_180703_3_, int p_180703_4_, ChunkPrimer p_180703_5_,
			double p_180703_6_, double p_180703_8_, double p_180703_10_) {
		this.func_180702_a(p_180703_1_, p_180703_3_, p_180703_4_, p_180703_5_, p_180703_6_, p_180703_8_, p_180703_10_,
				1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
	}

	protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_,
		...
		for (boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
			...
			if (!flag2 && p_180702_15_ == j && p_180702_12_ > 1.0F && p_180702_16_ > 0) {
				this.func_180702_a(random.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_,
									...
									for (int j2 = l; j2 > l2; --j2) {
										...
										if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D) {
											...
											if (this.func_175793_a(iblockstate1, iblockstate2)) {
												if (j2 - 1 < 10) {
													p_180702_5_.setBlockState(j3, j2, i2,
													...
													if (flag1 && p_180702_5_.getBlockState(j3, j2 - 1, i2)
														...
														blockpos$mutableblockpos.func_181079_c(j3 + p_180702_3_ * 16, 0,
																i2 + p_180702_4_ * 16);
	...
	protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_,
		...
		for (int j = 0; j < i; ++j) {
			...
			for (int l = 0; l < k; ++l) {
				...
				this.func_180702_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2, f, f1,
						0, 0, 1.0D);
			}
		}
	}
