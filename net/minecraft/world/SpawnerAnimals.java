...
public final class SpawnerAnimals {
	 ...
	 */
	public int findChunksForSpawning(WorldServer p_77192_1_, boolean spawnHostileMobs, boolean spawnPeacefulMobs,
			boolean p_77192_4_) {
				...
				if ((!enumcreaturetype.getPeacefulCreature() || spawnPeacefulMobs)
					...
					if (j4 <= k4) {
						...
						for (ChunkCoordIntPair chunkcoordintpair1 : this.eligibleChunksForSpawning) {
							BlockPos blockpos = getRandomChunkPosition(p_77192_1_, chunkcoordintpair1.chunkXPos,
							...
							if (!block.isNormalCube()) {
								...
								for (int k2 = 0; k2 < 3; ++k2) {
									...
									for (int l3 = 0; l3 < 4; ++l3) {
										...
										if (!p_77192_1_.isAnyPlayerWithinRangeAt((double) f, (double) i3, (double) f1,
												24.0D)
												&& blockpos2.distanceSq((double) f, (double) i3,
														(double) f1) >= 576.0D) {
											if (biomegenbase$spawnlistentry == null) {
												biomegenbase$spawnlistentry = p_77192_1_
											...
											if (p_77192_1_.canCreatureTypeSpawnHere(enumcreaturetype,
												...
												if (entityliving.getCanSpawnHere() && entityliving.isNotColliding()) {
													ientitylivingdata = entityliving
															.onInitialSpawn(
																	p_77192_1_.getDifficultyForLocation(
	...
	public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType p_180267_0_, World worldIn,
			BlockPos pos) {
	 ...
	 */
	public static void performWorldGenSpawning(World worldIn, BiomeGenBase p_77191_1_, int p_77191_2_, int p_77191_3_,
			int p_77191_4_, int p_77191_5_, Random p_77191_6_) {
		...
		if (!list.isEmpty()) {
			while (p_77191_6_.nextFloat() < p_77191_1_.getSpawningChance()) {
				...
				int i = biomegenbase$spawnlistentry.minGroupCount + p_77191_6_.nextInt(
					...
					for (int k1 = 0; !flag && k1 < 4; ++k1) {
						...
						if (canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType.ON_GROUND, worldIn,
							...
							entityliving.setLocationAndAngles((double) ((float) j + 0.5F), (double) blockpos.getY(),
									(double) ((float) k + 0.5F), p_77191_6_.nextFloat() * 360.0F, 0.0F);
						...
						for (k += p_77191_6_.nextInt(5) - p_77191_6_.nextInt(5); j < p_77191_2_
								|| j >= p_77191_2_ + p_77191_4_ || k < p_77191_3_
								|| k >= p_77191_3_ + p_77191_4_; k = i1 + p_77191_6_.nextInt(5)
