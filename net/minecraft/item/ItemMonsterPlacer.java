...
public class ItemMonsterPlacer extends Item {
	...
	public int getColorFromItemStack(ItemStack stack, int renderPass) {
		...
		return entitylist$entityegginfo != null
				? (renderPass == 0 ? entitylist$entityegginfo.primaryColor : entitylist$entityegginfo.secondaryColor)
				: 16777215;
	}
	...
	public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side,
		...
		if (worldIn.isRemote) {
			...
			Entity entity = spawnCreature(worldIn, stack.getMetadata(), (double) pos.getX() + 0.5D,
			...
			if (movingobjectposition == null) {
				...
				if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
					...
					if (worldIn.getBlockState(blockpos).getBlock() instanceof BlockLiquid) {
						Entity entity = spawnCreature(worldIn, itemStackIn.getMetadata(),
