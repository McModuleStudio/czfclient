...
public class UserListOpsEntry extends UserListEntry<GameProfile> {
	...
	public UserListOpsEntry(JsonObject p_i1150_1_) {
		...
		this.field_183025_b = p_i1150_1_.has("bypassesPlayerLimit")
	...
	protected void onSerialization(JsonObject data) {
		if (this.getValue() != null) {
			data.addProperty("uuid", ((GameProfile) this.getValue()).getId() == null ? ""
					: ((GameProfile) this.getValue()).getId().toString());
