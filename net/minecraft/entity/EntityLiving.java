...
public abstract class EntityLiving extends EntityLivingBase {
	...
	protected void dropEquipment(boolean p_82160_1_, int p_82160_2_) {
		for (int i = 0; i < this.getInventory().length; ++i) {
			...
			if (itemstack != null && (p_82160_1_ || flag)
					&& this.rand.nextFloat() - (float) p_82160_2_ * 0.01F < this.equipmentDropChances[i]) {
	...
	public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
		...
		if (itemStackIn == null || getArmorPosition(itemStackIn) == i
	...
	public static enum SpawnPlacementType {
		...
		private static final EntityLiving.SpawnPlacementType[] $VALUES = new EntityLiving.SpawnPlacementType[] {
