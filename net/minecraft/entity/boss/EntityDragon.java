	...
	public void onLivingUpdate() {
		...
		if (this.getHealth() <= 0.0F) {
			...
			if (this.isAIDisabled()) {
				...
				float f18 = MathHelper
						.sin(this.rotationYaw * (float) Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
				float f19 = MathHelper
						.cos(this.rotationYaw * (float) Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
