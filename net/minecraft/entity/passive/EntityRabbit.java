...
public class EntityRabbit extends EntityAnimal {
	...
	public float func_175521_o(float p_175521_1_) {
		return this.field_175535_bn == 0 ? 0.0F
				: ((float) this.field_175540_bm + p_175521_1_) / (float) this.field_175535_bn;
	}
	...
	public EntityRabbit createChild(EntityAgeable ageable) {
		...
		if (ageable instanceof EntityRabbit) {
			entityrabbit.setRabbitType(
					this.rand.nextBoolean() ? this.getRabbitType() : ((EntityRabbit) ageable).getRabbitType());
		}
	...
	static class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T> {
		...
		public AIAvoidEntity(EntityRabbit p_i46403_1_, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_,
				double p_i46403_6_) {
