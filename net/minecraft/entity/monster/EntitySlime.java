...
public class EntitySlime extends EntityLiving implements IMob {
	...
	protected void func_175451_e(EntityLivingBase p_175451_1_) {
		...
		if (this.canEntityBeSeen(p_175451_1_)
				&& this.getDistanceSqToEntity(p_175451_1_) < 0.6D * (double) i * 0.6D * (double) i
				&& p_175451_1_.attackEntityFrom(DamageSource.causeMobDamage(this), (float) this.getAttackStrength())) {
