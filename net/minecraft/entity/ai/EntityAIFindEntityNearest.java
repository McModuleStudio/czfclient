...
public class EntityAIFindEntityNearest extends EntityAIBase {
		...
		this.field_179443_c = new Predicate<EntityLivingBase>() {
			public boolean apply(EntityLivingBase p_apply_1_) {
				...
				return p_apply_1_.isInvisible() ? false
						: ((double) p_apply_1_.getDistanceToEntity(EntityAIFindEntityNearest.this.field_179442_b) > d0
								? false
	...
	public boolean shouldExecute() {
		...
		List<EntityLivingBase> list = this.field_179442_b.worldObj.<EntityLivingBase>getEntitiesWithinAABB(
				this.field_179439_f, this.field_179442_b.getEntityBoundingBox().expand(d0, 4.0D, d0),
				this.field_179443_c);
