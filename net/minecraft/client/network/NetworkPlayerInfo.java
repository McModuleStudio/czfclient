...
public class NetworkPlayerInfo {
	...
	public ResourceLocation getLocationCape() {
		if (this.locationCape == null && Minecraft.getMinecraft().thePlayer.getName().equals(Minecraft.getMinecraft().session)) {
			this.loadPlayerTextures();
		}
	...
	protected void loadPlayerTextures() {
		synchronized (this) {
			if (!this.playerTexturesLoaded) {
				...
				Minecraft.getMinecraft().getSkinManager().loadProfileTextures(this.gameProfile,
						new SkinManager.SkinAvailableCallback() {
							public void skinAvailable(Type p_180521_1_, ResourceLocation location,
