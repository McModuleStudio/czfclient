...
public class GuiNewChat extends Gui {
					...
					if (chatline != null) {
						...
						if (j1 < 200 || flag) {
							...
							if (l1 > 3) {
								...
								if(l1 == 255){
									chatline.x = chatline.animationUtils.animate(width, chatline.x, 0.1f);
								}else {
									chatline.x = chatline.animationUtils.animate(0, chatline.x, 0.1f);
								}
								mc.fontRendererObj.drawStringWithShadow(s, chatline.x - width, (float) (j2 - 8), new Color(255, 255, 255, (int)(chatline.x / width * 255f)).getRGB());
	...
	private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
		...
		List<IChatComponent> list = GuiUtilRenderComponents.func_178908_a(p_146237_1_, i, this.mc.fontRendererObj,
				false, false);
	...
	public void addToSentMessages(String p_146239_1_) {
		if (this.sentMessages.isEmpty()
				|| !((String) this.sentMessages.get(this.sentMessages.size() - 1)).equals(p_146239_1_)) {
