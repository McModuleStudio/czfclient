...
import gq.vapu.czfclient.UI.Settings.CzfSettingsMain;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(114514, this.width / 2 - 155, this.height / 6 + 24 - 6, 150, 20,"Czf Client"));
	...
	public String func_175355_a(EnumDifficulty p_175355_1_) {
		...
		ichatcomponent
				.appendSibling(new ChatComponentTranslation(p_175355_1_.getDifficultyResourceKey(), new Object[0]));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		if (button.enabled) {
			if (button.id < 100 && button instanceof GuiOptionButton) {
				...
				button.displayString = this.game_settings_1
			...
			if (button.id == 114514) {
				this.mc.gameSettings.saveOptions();
				this.mc.displayGuiScreen(new CzfSettingsMain(this));
			}
		}
	}
