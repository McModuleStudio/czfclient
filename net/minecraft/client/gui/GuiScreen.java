		...
		if (p_175272_1_ != null && p_175272_1_.getChatStyle().getChatHoverEvent() != null) {
			...
			if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
				...
				if (itemstack != null) {
					...
					this.drawCreativeTabHoveringText(EnumChatFormatting.RED + "Invalid Item!", p_175272_2_,
							p_175272_3_);
				}
				...
				if (this.mc.gameSettings.advancedItemTooltips) {
					try {
						...
						if (nbtbase1 instanceof NBTTagCompound) {
							...
							this.drawCreativeTabHoveringText(EnumChatFormatting.RED + "Invalid Entity!", p_175272_2_,
									p_175272_3_);
						}
				...
				this.drawHoveringText(NEWLINE_SPLITTER.splitToList(hoverevent.getValue().getFormattedText()),
				...
				if (statbase != null) {
					...
					this.drawCreativeTabHoveringText(EnumChatFormatting.RED + "Invalid statistic/achievement!",
							p_175272_2_, p_175272_3_);
				}
			}
		...
		if (p_175276_1_ == null) {
			...
			if (isShiftKeyDown()) {
				...
				if (clickevent.getAction() == ClickEvent.Action.OPEN_URL) {
					...
					if (clickevent.getValue().startsWith(".")) {
						mc.thePlayer.sendQueue.addToSendQueue(new C01PacketChatMessage(clickevent.getValue()));
						return true;
					}
