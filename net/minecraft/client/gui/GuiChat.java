...
public class GuiChat extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		Gui.drawRect(26, this.height - 14, this.width - 2, this.height - 2,
				new Color(108, 108, 108, 160).getRGB());
		RenderUtil.R2DUtils.drawRoundedRect(2, this.height - 14, 28, this.height - 2, new Color(234, 234, 234,160).getRGB(),
				new Color(234, 234, 234,160).getRGB());
		CFontRenderer font = FontLoaders.GoogleSans16;
		if (inputField.getText().startsWith(".") && !inputField.getText().contains(".irc")) {
			font.drawString("CMD", 6, this.height - 12, new Color(110, 37, 147).getRGB());
		} else if (inputField.getText().startsWith(".irc")) {
			font.drawString("IRC", 8, this.height - 12, new Color(110, 37, 147).getRGB());
		} else if (inputField.getText().startsWith(".ir")) {
			font.drawString("IRC", 8, this.height - 12, new Color(110, 37, 147).getRGB());
		} else if (inputField.getText().startsWith(".i")) {
			font.drawString("IRC", 8, this.height - 12, new Color(110, 37, 147).getRGB());
		} else if (inputField.getText().startsWith("/")) {
			font.drawString("CMD", 6, this.height - 12, new Color(110, 37, 147).getRGB());
		} else {
			font.drawString("CHAT", 4, this.height - 12, new Color(110, 37, 147).getRGB());
		}
