...
import gq.vapu.czfclient.API.EventWorld;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    //public NetHandlerPlayClient netHandler = thePlayer.sendQueue;
     ...
     */
    private void iIiiIiiiIIIIiI() throws LWJGLException, IOException, AWTException {
//        Name = System.getProperty("wtfnmsl");
//        if(this.Name == null){
//            JOptionPane.showMessageDialog(null, "Please Use List Launcher To Launch Client!", "Checker", 0);
//            System.exit(114514);
//        }
        ...
        {
            this.fontRendererObj.setUnicodeFlag(this.gameSettings.forceUnicodeFont); // 强制非unicode字体
        ...
        {
            //Object objResult = JOptionPane.showInputDialog(null, "UserName", "SkidBlue", 2, null, null, null);
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("ClientRes/Icon/McModuleStudio.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("ClientRes/Icon/McModuleStudio.png"));
    ...
    private void drawSplashScreen(TextureManager textureManagerInstance) throws LWJGLException
    {
        ...
        GlStateManager.enableTexture2D();
        InputStream inputstream = null;
        RenderUtil.drawImage(new ResourceLocation("ClientRes/mainMenu/Load.png"), 0, 0, new ScaledResolution(this).getScaledWidth(), new ScaledResolution(this).getScaledHeight());
    ...
    private void runGameLoop() throws IOException
    {
        ...
        {
            //if(Client.getModuleManager().getModuleByClass(FakeFPS.class).isEnabled()){
                //debugFPS = FakeFPS.FPS.getValue();
            //}else {
    ...
    {
        EventWorld ew = new EventWorld(worldClientIn, loadingMessage);
        EventBus.getInstance().register(ew);
...
//		try {
//			String LLL=WebUtils.get("https://wdnmdsb.coding.net/p/listclient/d/web/git/raw/master/Version/Ver.txt");
//			String HWID=HWIDUtils.getHWID();
////			if(!LLL.contains("Ver:"+Client.ver)) {
////				JOptionPane.showMessageDialog(null, "Version Update", "Info", JOptionPane.ERROR_MESSAGE);
////				System.exit(0);
////			}
//			if (!LLL.contains(HWID)) {
//			    HWIDUtils.setClipboardString();
//				JOptionPane.showInputDialog(null,"U cannot using PCL Launch Czf Client!", "L NMSL", JOptionPane.ERROR_MESSAGE);
//				System.exit(0);
//			}else {
//				Name=getSubString(LLL,HWID+"-",":"+HWID+";");
//                //Name = JOptionPane.showInputDialog("Username:");
//			}
//		} catch (NoSuchAlgorithmException | IOException e) {
//			JOptionPane.showMessageDialog(null, "Internet Error", "Info", JOptionPane.ERROR_MESSAGE);
//			System.exit(0);
//		}
//	}
//
