...
public class GameSettings {
	...
	public void setOptionValue(GameSettings.Options p_74306_1_, int p_74306_2_) {
		...
		if (p_74306_1_ == GameSettings.Options.FORCE_UNICODE_FONT) {
			...
			this.mc.fontRendererObj.setUnicodeFlag(forceUnicodeFont);
...
//					.setUnicodeFlag(this.mc.getLanguageManager().isCurrentLocaleUnicode() || this.forceUnicodeFont);
	...
	public static enum Options {
		...
		SMOOTH_FPS("", 999, "of.options.SMOOTH_FPS", false, false), CLOUDS("", 999, "of.options.CLOUDS", false, false),
		CLOUD_HEIGHT("", 999, "of.options.CLOUD_HEIGHT", true, false), TREES("", 999, "of.options.TREES", false, false),
		...
		AO_LEVEL("", 999, "of.options.AO_LEVEL", true, false), LAGOMETER("", 999, "of.options.LAGOMETER", false, false),
		...
		WEATHER("", 999, "of.options.WEATHER", false, false), SKY("", 999, "of.options.SKY", false, false),
		STARS("", 999, "of.options.STARS", false, false), SUN_MOON("", 999, "of.options.SUN_MOON", false, false),
		...
		TIME("", 999, "of.options.TIME", false, false), CLEAR_WATER("", 999, "of.options.CLEAR_WATER", false, false),
