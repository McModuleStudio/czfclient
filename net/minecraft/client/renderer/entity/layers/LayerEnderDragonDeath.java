...
public class LayerEnderDragonDeath implements LayerRenderer<EntityDragon> {
	public void doRenderLayer(EntityDragon entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks,
		...
		if (entitylivingbaseIn.deathTicks > 0) {
			...
			for (int i = 0; (float) i < (f + f * f) / 2.0F * 60.0F; ++i) {
				...
				worldrenderer.pos(-0.866D * (double) f3, (double) f2, (double) (-0.5F * f3)).color(255, 0, 255, 0)
						.endVertex();
				worldrenderer.pos(0.866D * (double) f3, (double) f2, (double) (-0.5F * f3)).color(255, 0, 255, 0)
						.endVertex();
