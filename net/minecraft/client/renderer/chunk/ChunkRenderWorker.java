...
public class ChunkRenderWorker implements Runnable {
				...
				public void onSuccess(List<Object> p_onSuccess_1_) {
					...
					label21: {
						try {
							...
							if (!generator.isFinished()) {
								ChunkRenderWorker.LOGGER.warn("Chunk render task was " + generator.getStatus()
	...
	private RegionRenderCacheBuilder getRegionRenderCacheBuilder() throws InterruptedException {
		return this.regionRenderCacheBuilder != null ? this.regionRenderCacheBuilder
				: this.chunkRenderDispatcher.allocateRenderBuilder();
	}
