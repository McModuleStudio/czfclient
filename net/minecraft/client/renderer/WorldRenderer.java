...
public class WorldRenderer {
	...
	private void func_181670_b(int p_181670_1_) {
		...
		if (p_181670_1_ > this.rawIntBuffer.remaining()) {
			...
			if (this.quadSprites != null) {
				...
				System.arraycopy(atextureatlassprite, 0, this.quadSprites, 0,
						Math.min(atextureatlassprite.length, this.quadSprites.length));
	...
	public void func_181674_a(float p_181674_1_, float p_181674_2_, float p_181674_3_) {
		...
		for (int j = 0; j < i; ++j) {
			afloat[j] = func_181665_a(this.rawFloatBuffer, (float) ((double) p_181674_1_ + this.xOffset),
	...
	private static float func_181665_a(FloatBuffer p_181665_0_, float p_181665_1_, float p_181665_2_, float p_181665_3_,
	...
	public WorldRenderer tex(double p_181673_1_, double p_181673_3_) {
		...
		int i = this.vertexCount * this.vertexFormat.getNextOffset()
				+ this.vertexFormat.func_181720_d(this.field_181678_g);
	...
	public void putColorMultiplier(float red, float green, float blue, int p_178978_4_) {
		...
		if (!this.needsUpdate) {
			...
			if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
				...
				j &= Client.instance.getModuleManager().getModuleByClass(Xray.class).isEnabled() ? 1073741824
						: -16777216;
				j = j | i1 << 16 | l << 8 | k;
			} else {
	...
	public WorldRenderer color(float p_181666_1_, float p_181666_2_, float p_181666_3_, float p_181666_4_) {
		return this.color((int) (p_181666_1_ * 255.0F), (int) (p_181666_2_ * 255.0F), (int) (p_181666_3_ * 255.0F),
