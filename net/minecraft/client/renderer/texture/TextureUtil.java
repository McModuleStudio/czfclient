...
public class TextureUtil {
	...
	public static void saveGlTexture(String p_saveGlTexture_0_, int p_saveGlTexture_1_, int p_saveGlTexture_2_,
			int p_saveGlTexture_3_, int p_saveGlTexture_4_) {
		...
		for (int i = 0; i <= p_saveGlTexture_2_; ++i) {
			...
			int[] aint = new int[l];
			GL11.glGetTexImage(GL11.GL_TEXTURE_2D, i, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV,
					(IntBuffer) intbuffer);
			intbuffer.get(aint);
